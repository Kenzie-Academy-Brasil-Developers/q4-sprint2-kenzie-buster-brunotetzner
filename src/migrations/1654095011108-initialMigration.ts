...
export class initialMigration1654095011108 implements MigrationInterface {
    name = 'initialMigration1654095011108'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "dvds" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "duration" integer NOT NULL, "cartUuid" uuid, "stockUuid" uuid NOT NULL, CONSTRAINT "REL_9ccb4c2c8ffde820b0b1de9ce5" UNIQUE ("stockUuid"), CONSTRAINT "PK_efe60a2cea0e03809c699ed9bf1" PRIMARY KEY ("uuid"))`);
        await queryRunner.query(`CREATE TABLE "carts" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "total" integer NOT NULL, "paid" boolean NOT NULL DEFAULT false, "userUuid" uuid, CONSTRAINT "PK_f866679bf24f872d7976c3bd833" PRIMARY KEY ("uuid"))`);
