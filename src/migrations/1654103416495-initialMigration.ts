...
export class initialMigration1654103416495 implements MigrationInterface {
    name = 'initialMigration1654103416495'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "dvds" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "duration" integer NOT NULL, "stockUuid" uuid NOT NULL, CONSTRAINT "REL_9ccb4c2c8ffde820b0b1de9ce5" UNIQUE ("stockUuid"), CONSTRAINT "PK_efe60a2cea0e03809c699ed9bf1" PRIMARY KEY ("uuid"))`);
        await queryRunner.query(`CREATE TABLE "carts" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "total" integer NOT NULL, "paid" boolean NOT NULL DEFAULT false, "userUuid" uuid, "dvdUuid" uuid, CONSTRAINT "PK_f866679bf24f872d7976c3bd833" PRIMARY KEY ("uuid"))`);
        ...
        await queryRunner.query(`ALTER TABLE "carts" ADD CONSTRAINT "FK_241a1d4b6ccb7f0e2cdec884521" FOREIGN KEY ("dvdUuid") REFERENCES "dvds"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "carts" DROP CONSTRAINT "FK_241a1d4b6ccb7f0e2cdec884521"`);
